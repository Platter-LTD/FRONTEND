    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 p-6 space-y-6">
        <div>
          ...
          <TextInput placeholder="example.com" type="url" value={callbackUrl} onChange={handleUrlChange(setCallbackUrl)} accentColor="#9A813F" />
        </div>
        ...
        <div>
          ...
          <TextInput placeholder="example.com" type="url" value={errorLogUrl} onChange={handleUrlChange(setErrorLogUrl)} accentColor="#9A813F" />
        </div>
      </div>
    </div>
  )
