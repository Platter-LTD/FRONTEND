    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-white rounded-lg px-12 py-6 w-[80%]">
        ...
        <div className="space-y-4">
          ...
          <Button className="w-full bg-black px-6 py-6 text-white hover:bg-gray-800 mt-6">
            Update
          </Button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg px-12 py-6 w-[80%]">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${twoFactorEnabled ? "bg-[#9A813F]" : "bg-gray-200"
                  }`}
              >
                <span
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${authenticatorEnabled ? "bg-[#9A813F]" : "bg-gray-200"
                  }`}
              >
                <span
          ...
          {/* Button */}
          <Button
            className="w-full bg-black py-6 px-6 text-white hover:bg-gray-800"
