...
export function AddAdminDrawer({ open, onOpenChange, onSuccess }: AddAdminDrawerProps) {
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} title="Add Staff" subtitle="">
      <div className="space-y-6">
        ...
        <Button className="w-full bg-[#3061F5] text-white hover:bg-[#2451d4]" onClick={handleInvite}>
          Invite
        </Button>
      </div>
    </Drawer>
