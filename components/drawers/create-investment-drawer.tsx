...
export default function CreateInvestmentDrawer({ isOpen, onClose, onSubmit, onBack, accentColor = "#9A813F" }: CreateInvestmentDrawerProps) {
  ...
  return (
    <Drawer
      ...
      title="Creating your investment"
      subtitle="Select the investment product you want to create with us"
    >
      <div className="space-y-4">
        <TextInput
          label="Name of product (investment)"
          placeholder="Name of product (investment)"
          value={productName}
