    ...
    const handlePress = (key: string | number) => {
        if (typeof key === 'number') {
            if (pin.length < 4) {
                ...
                setPin(newPin);
                if (newPin.length === 4) {
                    // Auto navigate or wait for user?
                    // Mockup doesn't show a "Next" button, usually auto-advance
                    setTimeout(() => {
                        router.push('/mobile-v2/profile/reset-password/confirm-pin');
                    }, 500);
                }
            }
        } else if (key === 'del') {
    ...
    return (
        <div className="flex flex-col h-full bg-[#FAFAFA] relative">
            ...
            <div className="pt-12 px-6 flex items-center mb-12">
                <Link href="/mobile-v2/profile/reset-password/otp" className="w-10 h-10 flex items-center justify-center -ml-2 text-gray-700">
            ...
            <div className="flex-1 flex flex-col items-center px-6">
                ...
                <h1 className="text-xl font-bold text-[#1E293B] mb-12">Enter New PIN</h1>
